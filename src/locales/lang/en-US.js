...
const locale = {
  ...
  'strategyLibrary.title': 'Internal Strategy Library',
  'strategyLibrary.subtitle': 'Shared indicators and scripts visible to everyone. Clone into your own library to use. AI summarizes each publish once.',
  'strategyLibrary.filterAll': 'All',
  'strategyLibrary.filterIndicator': 'Indicator',
  'strategyLibrary.filterScript': 'Script',
  'strategyLibrary.searchPlaceholder': 'Search title, notes, or publisher',
  'strategyLibrary.empty': 'No shared strategies yet — publish one from the IDE',
  'strategyLibrary.typeIndicator': 'Indicator',
  'strategyLibrary.typeScript': 'Script',
  'strategyLibrary.cloneCount': 'Cloned {n} times',
  'strategyLibrary.noSummary': 'No AI summary',
  'strategyLibrary.publisher': 'Publisher',
  'strategyLibrary.aiSummary': 'AI Strategy Summary',
  'strategyLibrary.aiLogic': 'Core logic',
  'strategyLibrary.aiSignals': 'Signals / execution',
  'strategyLibrary.aiRisks': 'Risks',
  'strategyLibrary.aiSuitability': 'Best for',
  'strategyLibrary.description': 'Notes',
  'strategyLibrary.code': 'Code',
  'strategyLibrary.clone': 'Clone to my library',
  'strategyLibrary.withdraw': 'Withdraw',
  'strategyLibrary.withdrawConfirmTitle': 'Withdraw this item?',
  'strategyLibrary.withdrawConfirmContent': 'Others will no longer see it. Existing clones stay with their owners.',
  'strategyLibrary.withdrawSuccess': 'Withdrawn',
  'strategyLibrary.withdrawFailed': 'Failed to withdraw',
  'strategyLibrary.cloneSuccess': 'Cloned to your private library',
  'strategyLibrary.cloneFailed': 'Clone failed',
  'strategyLibrary.loadFailed': 'Failed to load',
  'strategyLibrary.publishAction': 'Publish to library',
  'strategyLibrary.publishModalTitle': 'Publish to Internal Strategy Library',
  'strategyLibrary.publishConfirm': 'Publish',
  'strategyLibrary.publishHint': 'Visible to all company accounts for cloning. AI generates a one-time summary.',
  'strategyLibrary.publishTitle': 'Title',
  'strategyLibrary.publishTitlePlaceholder': 'Display name in the library',
  'strategyLibrary.publishDescription': 'Notes',
  'strategyLibrary.publishDescriptionPlaceholder': 'Optional: use cases, caveats, etc.',
  'strategyLibrary.publishSuccess': 'Published to internal strategy library',
  'strategyLibrary.publishFailed': 'Publish failed',
  'strategyCenter.header.strategyLibrary': 'Strategy Library',
  'strategyIde.selectScriptLabel': 'Script',
  'portfolioStrategy.title': 'A-Share Portfolio Backtest',
  'portfolioStrategy.desc': 'Multiple CN A-shares share one cash account with score-based selection and lot sizing. Lot size 100, T+1 and A-share fees are enforced.',
  'portfolioStrategy.symbolPool': 'Universe',
  'portfolioStrategy.symbolPlaceholder': 'Enter symbols separated by spaces, commas or newlines, e.g. 600519 000001.SZ',
  'portfolioStrategy.add': 'Add / Normalize',
  'portfolioStrategy.restoreDefault': 'Restore defaults',
  'portfolioStrategy.poolHint': '1–50 symbols; the four defaults are UI starters only.',
  'portfolioStrategy.capital': 'Initial capital',
  'portfolioStrategy.startDate': 'Start date',
  'portfolioStrategy.endDate': 'End date',
  'portfolioStrategy.run': 'Run portfolio backtest',
  'portfolioStrategy.running': 'Running...',
  'portfolioStrategy.equityChart': 'Strategy equity',
  'portfolioStrategy.finalPositions': 'Final positions',
  'portfolioStrategy.trades': 'All trades',
  'portfolioStrategy.meta': 'Run metadata',
  'portfolioStrategy.noPositions': 'No open positions',
  'portfolioStrategy.downloadReport': 'Download report',
  'portfolioStrategy.downloadTrades': 'Download trades.csv',
  'portfolioStrategy.finalEquity': 'Final equity',
  'portfolioStrategy.totalReturn': 'Total return',
  'portfolioStrategy.benchmarkReturn': 'Benchmark return',
  'portfolioStrategy.maxDrawdown': 'Max drawdown',
  'portfolioStrategy.sharpe': 'Sharpe',
  'portfolioStrategy.winRate': 'Win rate',
  'portfolioStrategy.totalTrades': 'Trades',
  'portfolioStrategy.errMin': 'Need at least {n} symbol(s)',
  'portfolioStrategy.errMax': 'At most {n} symbols',
  'portfolioStrategy.errDates': 'Please select start and end dates',
  'portfolioStrategy.jobFailed': 'Portfolio backtest failed',
  'portfolioStrategy.jobSucceeded': 'Backtest finished, run #{id}',
  'portfolioStrategy.jobPolling': 'Job {status} ({id}), polling...',
  'portfolioStrategy.col.symbol': 'Symbol',
  'portfolioStrategy.col.shares': 'Shares',
  'portfolioStrategy.col.avgCost': 'Avg cost',
  'portfolioStrategy.col.lastPrice': 'Last',
  'portfolioStrategy.col.marketValue': 'Market value',
  'portfolioStrategy.col.unrealized': 'Unrealized',
  'portfolioStrategy.col.weight': 'Weight',
  'portfolioStrategy.col.time': 'Time',
  'portfolioStrategy.col.type': 'Side',
  'portfolioStrategy.col.reason': 'Reason',
  'portfolioStrategy.col.price': 'Price',
  'portfolioStrategy.col.amount': 'Qty',
  'portfolioStrategy.col.profit': 'PnL',
  'portfolioStrategy.col.cash': 'Cash',
